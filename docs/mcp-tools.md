...
Docking (`python -m tools.docking`), MD (`python -m tools.md`), literature
search (`python -m tools.literature`), experiment preset IDs, `--from-run`,
...
Docking, MD, and literature are **not** MCP tools.
